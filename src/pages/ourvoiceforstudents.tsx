    ...
    return (
        <Layout title="OurVoice For Students" headerText="OurVoice For Students">
            <div className="texts" style={{ "paddingLeft": "10%", "paddingRight": "10%" }}>
                ...
                <li>can give your students a voice for less than a quarter of the price of a single #2 pencil. 
                More than ⅔ of students feel uncomfortable sharing suggestions or concerns directly with their teachers<a href="https://www.quagliainstitute.org/uploads/legacy/Student_Voice_Grades_6-12_Decade_of_Data_Report.pdf">(QISVA)</a>. </li>
                </ul>
                </div>
